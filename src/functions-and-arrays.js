...
function sumNumbers(addNumbers) {
  let sum = 0;
...
function averageNumbers(arrAverage) {
  let average = sumNumbers(numbersAvg);
  return average / arrAverage.length
}
...
console.log(doesWordExist('trouble', wordsFind));
